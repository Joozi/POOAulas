...
cout << "<DIGITE SEGUNDO NUMERO DO CODIGO NO TERMINAL> ";
	cin >> codigo;
		...
		;
		 cout << "DIGITE O TERCEIRO DO CODIGO NO TERMINAL> ";
		 cin >> codigo;
		 if (codigo == num3) cod3 = true;
		 cout << "DIGITE O QUARTO DO CODIGO NO TERMINAL> ";
    	 cin >> codigo;
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	//SE FOR VERDADEIRO, ELE VAI ACENDER, SE FOR FALSO, VAI FICAR APAGADO.
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
